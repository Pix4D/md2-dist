import { ElementRef, OnDestroy, EventEmitter, Renderer, TemplateRef, ViewContainerRef, ModuleWithProviders } from '@angular/core';
...
export declare class Md2Datepicker implements OnDestroy, ControlValueAccessor {
    ...
    constructor(_element: ElementRef, overlay: Overlay, _renderer: Renderer, _viewContainerRef: ViewContainerRef, _locale: DateLocale, _util: DateUtil, _control: NgControl);
    ngOnDestroy(): void;
    placeholder: string;
    okLabel: string;
    cancelLabel: string;
