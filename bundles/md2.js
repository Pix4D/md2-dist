/**
  ...
  * License: MIT
  */
import { ApplicationRef, Attribute, ChangeDetectorRef, Component, ComponentFactoryResolver, ContentChildren, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Inject, Injectable, Injector, Input, IterableDiffers, NgModule, NgZone, OpaqueToken, Optional, Output, Pipe, QueryList, Renderer, Self, SkipSelf, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, ViewEncapsulation, animate, forwardRef, isDevMode, keyframes, state, style, transition, trigger } from '@angular/core';
...
let Md2Autocomplete = class Md2Autocomplete {
    ...
    updateItems(query) {
        if (this._inputValue.length < this.minLength) {
            ...
            this._list = this._items.map((i) => new Item(i, this.textKey, this.valueKey)).filter(i => query.test(i.text));
...
Md2Autocomplete = __decorate$34([
    ...
    __metadata$20("design:paramtypes", [ElementRef])
], Md2Autocomplete);
...
__decorate$36([
    ...
    __metadata$21("design:type", NgForm)
...
let Md2Colorpicker = class Md2Colorpicker {
    constructor(_element, overlay, _viewContainerRef, _renderer, service, _control) {
        this._element = _element;
...
Md2Colorpicker = __decorate$38([
    ...
    __metadata$23("design:paramtypes", [ElementRef, Overlay,
        ViewContainerRef, Renderer,
        ColorpickerService, NgControl])
], Md2Colorpicker);
class Hsva {
    constructor(h, s, v, a) {
        this.h = h;
...
__decorate$42([
    ViewChild('trigger'),
    __metadata$25("design:type", ElementRef)
], Md2Select.prototype, "trigger", void 0);
__decorate$42([
    ViewChild(ConnectedOverlayDirective),
    __metadata$25("design:type", ConnectedOverlayDirective)
...
Md2DataTable = __decorate$40([
    ...
    __metadata$24("design:paramtypes", [IterableDiffers])
], Md2DataTable);
...
const MONTH_LONG_NAMES = split('January,February,March,April,May,June,July,August,September,October,November,December', /,/g);
const MONTH_SHORT_NAMES = map(MONTH_LONG_NAMES, val3); // ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
// ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
const WEEK_LONG_NAMES = split('Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', /,/g);
const WEEK_SHORT_NAMES = map(WEEK_LONG_NAMES, val3);
const MERIDIAN_NAMES = split('am,pm', /,/g);
const MERIDIAN_NAMES_FULL = split('am,am,am,am,am,am,am,am,am,am,am,am,pm,pm,pm,pm,pm,pm,pm,pm,pm,pm,pm,pm', /,/g);
const PARSE_DATE_MAP = {
    'y': 0,
    'Y': [0, -2000],
    'M': [1, 1],
...
let Md2Datepicker = class Md2Datepicker {
    constructor(_element, overlay, _renderer, _viewContainerRef, _locale, _util, _control) {
        this._element = _element;
        this.overlay = overlay;
        this._renderer = _renderer;
        this._viewContainerRef = _viewContainerRef;
    ...
    _handleBlur(event) {
        ...
        let el = event.target;
        let d = this._util.parseDate(el.value, this.format);
...
Md2Datepicker = __decorate$45([
    ...
    __param$9(6, Self()), __param$9(6, Optional()),
    __metadata$27("design:paramtypes", [ElementRef, Overlay, Renderer,
        ViewContainerRef, DateLocale,
        DateUtil, NgControl])
], Md2Datepicker);
const MD2_DATEPICKER_DIRECTIVES = [Md2Datepicker, Md2Clock];
let Md2DatepickerModule = Md2DatepickerModule_1 = class Md2DatepickerModule {
    static forRoot() {
        return {
...
Md2DatepickerModule = Md2DatepickerModule_1 = __decorate$45([
    NgModule({
        imports: [CommonModule, FormsModule, OverlayModule, PortalModule],
...
Md2DialogModule = Md2DialogModule_1 = __decorate$48([
    NgModule({
...
Md2MenuTrigger = __decorate$52([
    ...
    __metadata$30("design:paramtypes", [ElementRef, Renderer])
], Md2MenuTrigger);
...
Md2MenuModule = Md2MenuModule_1 = __decorate$49([
    NgModule({
        imports: [CommonModule],
...
Md2TabLabel = __decorate$53([
    ...
    __metadata$31("design:paramtypes", [TemplateRef, Md2Tab])
], Md2TabLabel);
...
__decorate$53([
    ...
    __metadata$31("design:type", QueryList)
...
Md2TabsModule = Md2TabsModule_1 = __decorate$53([
    NgModule({
        imports: [CommonModule],
...
let Md2Tags = class Md2Tags {
    ...
    filterMatches(query) {
        ...
        this._list = tempList.filter((t) => (query.test(t.text) && !this._items.find((i) => t.text === i.text)));
...
Md2TagsModule = Md2TagsModule_1 = __decorate$54([
    NgModule({
        imports: [CommonModule, FormsModule, Md2AutocompleteModule],
...
Md2Toast = __decorate$55([
    Injectable(),
    __metadata$33("design:paramtypes", [Overlay, Md2ToastConfig])
], Md2Toast);
...
Md2ToastModule = Md2ToastModule_1 = __decorate$55([
    NgModule({
        imports: [CommonModule],
...
Md2Tooltip = __decorate$57([
    ...
    __metadata$34("design:paramtypes", [Overlay,
        ElementRef,
        ScrollDispatcher,
        ViewContainerRef,
        NgZone,
...
Md2TooltipComponent = __decorate$57([
    ...
    __metadata$34("design:paramtypes", [Dir, ChangeDetectorRef])
], Md2TooltipComponent);
...
Md2TooltipModule = Md2TooltipModule_1 = __decorate$56([
    NgModule({
